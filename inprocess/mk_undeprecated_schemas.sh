...
mv ead3_undeprecated-driver-compiled.rng ../undeprecated/ead3_undeprecated.rng 
...
java -jar  $DTD_FLATTEN ead3_undeprecated_dtd-compiled.dtd > ../undeprecated/ead3_undeprecated.dtd
